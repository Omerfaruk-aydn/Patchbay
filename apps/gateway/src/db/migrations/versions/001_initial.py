...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("created_at", sa.TIMESTAMPTZ(), server_default=sa.text("now()")),
        sa.Column("last_used_at", sa.TIMESTAMPTZ(), nullable=True),
    )
    ...
    op.create_table(
        ...
        sa.Column("last_synced_at", sa.TIMESTAMPTZ(), server_default=sa.text("now()")),
    ...
    op.create_table(
        ...
        sa.Column("started_at", sa.TIMESTAMPTZ(), server_default=sa.text("now()")),
